...
static const struct option long_options[] = {
    ...
    {"lna", required_argument, 0,'w'},
    {"lnbf",required_argument, 0,'l'},
    {"search", required_argument, 0,'L'},
    {"monitor", no_argument, 0, 'm'},
    {"output", required_argument, 0, 'o'},
    {"pat",  no_argument, 0,'p'},
    {"all-pids", no_argument, 0, 'P'},
    {"record", no_argument, 0, 'r'},
    {"silence", no_argument, 0 ,'s'},
    {"sat_number", required_argument, 0, 'S'},
    {"timeout", required_argument, 0,'t'},
    {"freq_bpf", required_argument, 0,'U'},
    {"verbose", no_argument, 0, 'v'},
    {"video_pid",required_argument, 0, 'V'},
    {"wait",required_argument, 0,'W'},
    {"exit",no_argument, 0,'x'},
    {"low_traffic",no_argument, 0, 'X'},
...
static int parse_opt(int argc, char* argv[],struct arguments* args)
{
